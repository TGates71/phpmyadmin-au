...
// Check PHP and DB versions - TGates

if ((version_compare(phpversion(), '5.5.0', '>=')) && (version_compare(mysql_get_server_info(), '5.5.0', '>=')))
{
	phpMyAdminUpdate();
} else {
	echo "PHP and/or MySQL version is below 5.5.0 - No update available.";
}
